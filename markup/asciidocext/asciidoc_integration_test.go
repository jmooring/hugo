...
func TestWorkingFolderCurrentWithDiagrams(t *testing.T) {
	...
	if ok, err := asciidocext.SupportsDitaaDiagrams(); !ok {
		t.Skip(err)
	}
	...
	for _, tc := range testCases {
		// TODO jmooring
		// Remove this after https://github.com/asciidoctor/asciidoctor-diagram/pull/497
		// is merged and the maintainer has rolled a new release, presumably 3.1.0.
...
[markup.asciidocext]
  ...
  [markup.asciidocext.attributes]
    diagram-cachedir = 'DIAGRAM_CACHEDIR'
	diagram-cache-images-option = true
