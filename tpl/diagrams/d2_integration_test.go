...
x -> y
~~~
-- content/integration_tests/m.md --
---
title: M
---
~~~d2svg {center=false,darkTheme="Dark Mauve",layoutEngine="tala",lightTheme="Terminal",minify=false,padding=20,scale=0.75,sketch=false,class="huey",id="duey",title="louie"}
x -> y
~~~
`
	...
	b.AssertFileContent("public/integration_tests/a/index.html", "b83c6cef4d3a7de1")
	b.AssertFileContent("public/integration_tests/b/index.html", "7d5ef4f3d7e95641")
	b.AssertFileContent("public/integration_tests/c/index.html", "682aeb184a698120")
	b.AssertFileContent("public/integration_tests/d/index.html", "1fad671213bcb447")
	b.AssertFileContent("public/integration_tests/e/index.html", "6a76f938a8497848")
	b.AssertFileContent("public/integration_tests/f/index.html", "7bce95d3ef52dafa")
	b.AssertFileContent("public/integration_tests/g/index.html", "1fd44476df72e615")
	b.AssertFileContent("public/integration_tests/h/index.html", "7db2d2e324e881d7")
	b.AssertFileContent("public/integration_tests/i/index.html", "589c2cdc8c4c007a")
	b.AssertFileContent("public/integration_tests/j/index.html", "32833f3ab7c130e5")
	b.AssertFileContent("public/integration_tests/k/index.html", "9b39a7a4897167b8")
	b.AssertFileContent("public/integration_tests/l/index.html", "a05d594a4dc92f98")
	b.AssertFileContent("public/integration_tests/m/index.html", "8644760ecb6cc5fd")
}
...
`
	...
	b.AssertFileContent("public/p1/index.html", "938f24a4bfd2b4a1")
	b.AssertFileContent("public/p2/index.html", "d99bce5d9b2d2304")
}
...
`
	...
	want = "error calling D2: layout engine must be one of elk, dagre, or tala"
	testErr(t, filesNew, want)
...
`
	...
	b.AssertFileContent("public/index.html", "f683218f5de59535")
}
